...
Neovim configuration directory, AutoHotkey configuration, Windows Terminal
settings, and Ditto settings. Existing targets are moved to timestamped backup
paths before the links are created. Creating symbolic links requires Windows
